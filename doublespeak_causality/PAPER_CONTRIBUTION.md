...
**Localization (T4 attribution patching, `NEXT3_FINDINGS.md`):** attribution patching — validated against true activation patching (pearson **0.89**, spearman 0.92) — localizes the distributed DS-context effect to the **earliest layers (L0 dominant) and the demonstration-codeword positions**, propagating upward. This refines the "distributed" characterization of §3.2 into "concentrated early, on the demonstration codewords."
