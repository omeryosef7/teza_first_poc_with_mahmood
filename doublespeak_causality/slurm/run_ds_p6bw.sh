#!/bin/bash
#SBATCH --job-name=ds_p6bw
#SBATCH --output=doublespeak_causality/logs/ds_p6bw_%j.out
#SBATCH --error=doublespeak_causality/logs/ds_p6bw_%j.err
#SBATCH --ntasks=1
...
python -u doublespeak_causality/scripts/phase6b_windows.py --bench data/bench/bench_curated.json --widths 2,4,8 --n-prompts 2 --splits dev,heldout
