...
python -u doublespeak_causality/scripts/phase5b_qkv.py --bench doublespeak_causality/data/bench/bench_curated.json --splits dev --carry L14H4_L15H8 --n-prompts 2
