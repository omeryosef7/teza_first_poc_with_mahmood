#!/bin/bash
#SBATCH --job-name=ds_stage2b_llama8b
#SBATCH --output=doublespeak_causality/logs/ds_stage2b_%j.out
#SBATCH --error=doublespeak_causality/logs/ds_stage2b_%j.err
#SBATCH --ntasks=1
...
#   sbatch --cpus-per-task=2 --mem=32G --time=00:40:00 --nodelist=n-802,n-803,n-804,n-805,t-806 slurm/run_stage2b_llama8b.sh
#
...
MARK="doublespeak_causality/outputs/.stage2b_llama8b.COMPLETE"
