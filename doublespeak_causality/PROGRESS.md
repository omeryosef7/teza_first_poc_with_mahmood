...
| P3 | Activation patching (§9) | ✅ COMPLETE (necessity) | **necessity CONFIRMED** bf16: DS←Neutral collapses P(harm) from mid-layers; identity✓ random✗ (126-8181x). Sufficiency INCONCLUSIVE (patchscope readout fails Direct-rep positive control; prior null retracted); RQ2 open. Necessity stands. |
