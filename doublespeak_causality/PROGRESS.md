...
| P3 | Activation patching (§9) | ✅ COMPLETE (necessity) | **necessity CONFIRMED** bf16: DS←Neutral collapses P(harm) from mid-layers; identity✓ random✗ (126-8181x). Sufficiency = ROBUST NULL (single-layer insufficient, both readouts); multi-layer test next. Stage-2b canonical=687215 |
