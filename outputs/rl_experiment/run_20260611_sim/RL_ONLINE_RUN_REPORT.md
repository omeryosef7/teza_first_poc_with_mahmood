...
**Generated:** 2026-06-11 18:44 UTC
...
**Condition selection counts:**
  - Condition A: 101 episodes  (ASR=66.3%)
  - Condition D: 61 episodes  (ASR=45.9%)
  - Condition E: 70 episodes  (ASR=42.9%)
  - Condition F: 68 episodes  (ASR=36.8%)
...
- **Episodes run:** 300
- **Mean reward (all episodes):** 0.565
- **ASR (all episodes):** 50.3%
- **ASR (last 50 episodes):** 48.0%
- **Dominant action (final policy):** **A**

**Condition selection counts:**
  - Condition A: 68 episodes  (ASR=73.5%)
  - Condition D: 81 episodes  (ASR=56.8%)
  - Condition E: 79 episodes  (ASR=32.9%)
  - Condition F: 72 episodes  (ASR=40.3%)
...
- **Episodes run:** 300
- **Mean reward (all episodes):** 0.476
- **ASR (all episodes):** 50.3%
- **ASR (last 50 episodes):** 62.0%
- **Dominant action (final policy):** **A**

**Condition selection counts:**
  - Condition A: 93 episodes  (ASR=77.4%)
  - Condition D: 67 episodes  (ASR=52.2%)
  - Condition E: 70 episodes  (ASR=28.6%)
  - Condition F: 70 episodes  (ASR=34.3%)
...
- Mean L22 (success episodes): 7.0883
- Mean L22 (failure episodes): 6.6287
- Δ (success − failure): 0.4595
- **L22 diagnostic: success episodes have HIGHER mean L22 projection (μ_success=7.09 vs μ_failure=6.63, Δ=0.46). This is inconsistent with the dampening hypothesis. The provisional direction may capture something other than refusal gating.**
...
### cost_mechanistic
- Episodes with L22 data: 73  (success: 44, failure: 29)
- Mean L22 (success episodes): 7.4345
- Mean L22 (failure episodes): 8.1888
- Δ (success − failure): -0.7542
- **L22 diagnostic: success episodes have LOWER mean L22 projection (μ_success=7.43 vs μ_failure=8.19, Δ=-0.75). Consistent with hypothesis that the provisional harmful-vs-harmless direction is dampened during successful CoT hijacking.**
- ⚠ L22 is labelled 'provisional harmful-vs-harmless contrast direction'. It is not a validated causal refusal mechanism. This analysis is diagnostic only.

### cost_l22_deflect
- Episodes with L22 data: 65  (success: 40, failure: 25)
- Mean L22 (success episodes): 7.3538
- Mean L22 (failure episodes): 8.4819
- Δ (success − failure): -1.1281
- **L22 diagnostic: success episodes have LOWER mean L22 projection (μ_success=7.35 vs μ_failure=8.48, Δ=-1.13). Consistent with hypothesis that the provisional harmful-vs-harmless direction is dampened during successful CoT hijacking.**
- ⚠ L22 is labelled 'provisional harmful-vs-harmless contrast direction'. It is not a validated causal refusal mechanism. This analysis is diagnostic only.
