...
**Author:** Omer Yosef · **Scope:** everything done from 2026-07-01 through 2026-07-18 on the GCG adversarial-suffix jailbreak research thread (Qwen3-14B, Gemma4-E4B-it, DeepSeek-R1-Distill-Qwen-7B), plus a one-paragraph precursor note on the late-June mechanistic thread it builds on.
...
|---|---|---|---|---|---|
| 5A CoT-target (25 beh) | §3 | 10.7% | *pending* | — | — |
| Standard GCG | §3 | 4.0% | *pending* | — | — |
| 7A full-520 (unseen) | §4 | 8.92% | *pending* | — | — |
| Phase 8 λ=0.3 | §5 | 24.0% | *pending* | — | — |
| Sprint-3 9A/9B/union | §8 | 11.2%/8.7%/14.0% | *pending* | — | — |
| Gemma4 10A EmptyThink | §8.5 | 3.91% | *pending* | — | — |
