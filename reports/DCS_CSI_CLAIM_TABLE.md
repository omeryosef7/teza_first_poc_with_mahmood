...
20. **"Basket's axis beats its fit-capacity-matched controls."** — **LIFTED FOR TRAIN ONLY (S-100).** Group K ran: with 24 shuffled-label controls the candidate is **rank 1 of 25, floor 0.0400**, and **zero** of the twelve new controls exceeded +0.00264 — the preregistered 0-above branch (S-083/S-095). The pooled family (46) passes at floor **0.0213**, and the preregistered exchangeability re-test at 24 vs 22 gives p = 0.8311, so the pooling stays legitimate. **STILL PROHIBITED HELD-OUT:** VALIDATION's shuffled family is **9** (rank 1 of 10, floor 0.10) — floor-limited, so no held-out statement about the fit-capacity-matched comparator may be made until job 901739 lands. Say "on TRAIN", never unqualified.
