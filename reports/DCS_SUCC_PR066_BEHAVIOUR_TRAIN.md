...
Preregistration: `configs/dcs_ts_pr066_amendment1.json` (FROZEN, file_sha16 `5278f55ac74f4d39`), loaded and ENFORCED through `scripts/dcs_ts_prereg.py`.
Producer: `scripts/dcs_succ_pr066_behaviour.py`  
Independence unit: **domain**. Rows are never cited as independent samples.  
Scope: TRAIN ONLY (checklist X5), 67 domains.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| A | 0 | 134 | 67 | 0.1418 | [0.0896, 0.1940] | 0.1343 | [0.0821, 0.1866] | 0.0000 | 0.0000 | 0.1017 | 0.0224 |
| A | 4 | 670 | 67 | 0.1224 | [0.0925, 0.1537] | 0.1030 | [0.0746, 0.1343] | 0.0075 | 0.0000 | 0.0784 | 0.0015 |
| B | 0 | 134 | 67 | 0.0000 | [0.0000, 0.0000] | 0.0000 | [0.0000, 0.0000] | 1.0000 | -- | 0.0000 | 0.0000 |
| B | 4 | 670 | 67 | 0.0000 | [0.0000, 0.0000] | 0.0000 | [0.0000, 0.0000] | 1.0000 | -- | 0.0000 | 0.0000 |
| C | 0 | 134 | 67 | 0.1866 | [0.1194, 0.2612] | 0.1791 | [0.1119, 0.2537] | 0.0000 | 0.0000 | 0.1306 | 0.0224 |
| C | 4 | 670 | 67 | 0.3463 | [0.3030, 0.3896] | 0.3224 | [0.2791, 0.3657] | 0.1119 | 0.0209 | 0.2621 | 0.0000 |
| E | 0 | 134 | 67 | 0.0000 | [0.0000, 0.0000] | 0.0000 | [0.0000, 0.0000] | 1.0000 | -- | 0.0000 | 0.0000 |
| E | 4 | 670 | 67 | 0.0015 | [0.0000, 0.0045] | 0.0015 | [0.0000, 0.0045] | 0.9985 | -- | 0.0015 | 0.0000 |

CIs are a **domain-clustered percentile bootstrap** (10000 resamples of the 67 domain clusters). An iid row-level interval on this population would be about sqrt(rows per domain) too narrow.
...
|---|---|---|---|---|---|---|---|---|
| Q1b | Q1b: C dose4 - C dose0 | 67 | 57 | 44/13/10 | 0.1433 | p = 4.71e-05 (attainable floor 1.388e-17) | 0.05 | True |
| Q1c | Q1c: C dose4 - A dose4 | 67 | 58 | 53/5/9 | 0.2194 | p = 3.496e-11 (attainable floor 6.939e-18) | 0.025 | True |
| Q1d | Q1d: C dose4 - B dose4 | 67 | 62 | 62/0/5 | 0.3224 | p = 4.337e-19 (attainable floor 4.337e-19) | 0.016667 | True |

## Kill condition

Pooled cell-C top-dose ASR@0.5 = **0.3224** against the declared bar 0.05 -- **not tripped**.
...
|---|---|---|---|---|---|
| **pooled** | 67 | 0.4836 | p = 9.999e-05 (attainable floor 9.999e-05) | [0.2753, 0.6485] | 0.7273 |
| test | 0 | NOT-EVALUABLE | fewer than 3 shared domains | -- | -- |
| train | 67 | 0.4836 | p = 9.999e-05 (attainable floor 9.999e-05) | [0.2753, 0.6485] | 0.7273 |
| validation | 0 | NOT-EVALUABLE | fewer than 3 shared domains | -- | -- |
...
Declared MDE 0.2996; sign agrees with the pooled estimate in 1 of 1 splits.
...
* **Q2b** (threshold 0.25): rho = 0.4036, p = 0.0007999 (attainable floor 9.999e-05), n = 67. Robustness, reported always.
* **Q2c** (stratified predictor at the frozen 0.5 cut, 55 installing / 12 not): rho = 0.2971, p = 0.014 (attainable floor 9.999e-05). Nothing is dropped by the stratification.

## Nulls

* **N1 -- NOT-EVALUABLE** (blocking for interpretation). ASR(C) - ASR(A) = 0.2194 at dose 4, but N5's disagreement rate is not measured, and N1's bar IS that rate
* **N2 -- NOT-EVALUABLE** (blocking for interpretation). paired dose contrast mean 0.1433, p = 4.71e-05 (attainable floor 1.388e-17); N5's disagreement rate is not measured, so 'substantially' has no bar
