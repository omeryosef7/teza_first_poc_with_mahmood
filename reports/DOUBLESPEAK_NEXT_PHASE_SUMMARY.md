...
| `R-041`/`R-043` ⚠ **narrowed by `A-009`/`R-051`** | **The effect is graded by how much of the remapping was installed.** Per-domain baseline *installation* predicts the size of `KO-3`'s effect on cell C: **ρ = −0.594** (Llama n=4), **−0.444** (Llama n=8), **−0.734** (Qwen3-14B) — three settings, two models, all negative. ✅ Robust to **leave-one-out** (38 subsets, worst p = 8.0e-04), to **three** operationalisations of the predictor (−0.799…−0.907), and to an **arm-exchangeable null** (p = 9.5e-04). ⛔ **NOT demonstrated within the partially-installed subrange alone** — on the 13 domains that vary, contrast −0.503, **p = 0.343**. ⛔ **The comparator is not reliably inert** (ρ<sub>ctrl</sub> = +0.31 / −0.04 / −0.02 / −0.33 across four populations), so the **−0.907 contrast is population-specific and inflated** and may not stand as *the* effect size | 3 populations × 38 domains; statistic audited (`A-006`) and claim audited (`A-009`) | ⚠ **CORRELATIONAL**, and **dominated by the ceiling-vs-rest contrast** |
