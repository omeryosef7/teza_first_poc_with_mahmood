...
def main():
    ...
    _atomic_json_dump({"provenance": prov, "pooled_CONFOUNDED": out,
               ...
               "note": "EXPLORATORY feasibility. Does not license a design; a predicted-refusal "
                       "control needs its own preregistration with held-out-arm validation."}, os.path.join(REPO, a.out), indent=1)
    print(f"\n-> {a.out}")
