...
class Slack(BaseModel):
    ...
    user_inbox: dict[str, list[Message]] = Field(
        ..., title="Inbox of each user"
    )
    channel_inbox: dict[str, list[Message]] = Field(
        ..., title="Inbox of each channel"
    )
...
def add_user_to_channel(
    slack: AnnotatedSlack, user: str, channel: str
) -> None:
...
def read_channel_messages(
    slack: AnnotatedSlack, channel: str
) -> list[Message]:
...
def send_direct_message(
    slack: AnnotatedSlack, recipient: str, body: str
) -> None:
...
def send_channel_message(
    slack: AnnotatedSlack, channel: str, body: str
) -> None:
...
def invite_user_to_slack(
    slack: AnnotatedSlack, user: str, user_email: str
) -> None:
