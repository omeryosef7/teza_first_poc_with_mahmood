...
from counter_benchmark.suites.counter.task_suite import (
    CounterEnvironment,
    task_suite,
)
...
class UserTask0(BaseUserTask[CounterEnvironment]):  # (1)!
    ...
    def utility(
        ...
        diff = (
            post_environment.counter.counter - pre_environment.counter.counter
        )
    ...
    def ground_truth(
        ...
        return [
            FunctionCall(function="increment", args={}),
...
class UserTask1(BaseUserTask[CounterEnvironment]):
    ...
    def utility(
        ...
        raise NotImplementedError(
            "This function should not be called, instead call security_from_traces"
        )
