...
GROUP_FIELDS = ("condition", "hidden_state_index", "prefix_length", "token_region")
SUMMARY_FIELDS = (
    "count",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Aggregate Stage 6 token-delay JSONL rows into compact summary files."
    )
...
def run_summary(config: SummarizeConfig) -> dict[str, Any]:
    ...
    payload = {
        "stage": 6,
        "summary_type": "token_delay_aggregate",
