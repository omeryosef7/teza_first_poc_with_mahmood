...
| C2 | Refusal restoration is **not** the route to attack removal | Llama + Qwen3 | same | 160/model | prompt, dose-matched **and causally, both models** | Llama n=4 gaps **0.0000**; Qwen3 n=8 refusal arm **worse**; **R-35/R-36/R-37: one patch removes 69.2% (Llama/A), 81.0% (Qwen3/A), 92.3% (Qwen3/B) of the refusal rise, all >2x margin, while the below-band control moves it by exactly 0.0000 in all three** | arm-vs-arm 0.0417 | same | zero-refusal arms; below-band L5 patch | **R + CAUSAL** |
